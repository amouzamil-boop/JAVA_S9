...
public class World {
    ...
    public World(String fileName) {
        ...
        try {
            ...
            buf.close(); // N'oubliez pas de fermer le buffer
        } catch (Exception e) {
     ...
     * Calcule la norme basée sur la formule du PDF
     */
    ...
    public static void main(String[] args) {
        ...
        // "./data/..." fonctionne si vous lancez le code depuis la racine du projet "TPJava"
        World w = new World("./src/data/airport-codes_no_comma.csv");


        System.out.println("Found " + w.getList().size() + " airports.");

        // Paris (latitude: 48.866, longitude 2.316)
        // ATTENTION: l'appel dans le PDF est (lon, lat)
        Aeroport paris = w.findNearestAirport(2.316, 48.866);
        Aeroport cdg = w.findByCode("CDG");

        // Le PDF indique que le plus proche doit être Orly (ORY)
